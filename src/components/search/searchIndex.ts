...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: 'settings-pension', label: 'Pension Contributions', description: 'Salary sacrifice, workplace, SIPP and employer pension setup', keywords: ['pension', 'salary sacrifice', 'employee', 'employer', 'sipp', 'contribution'], tab: 'settings', targetSelector: '[data-search="settings-pension"]' },
