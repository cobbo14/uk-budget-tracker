...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: 'pension-optimiser', label: 'Pension Optimiser', description: 'Personalised contribution recommendations, marginal relief, affordability and best route', keywords: ['pension', 'optimiser', 'optimise', 'contribution', 'chart', 'employer match', 'recommendations', 'marginal relief'], tab: 'planning', targetSelector: '[data-tour="pension-optimiser"]', budgetingModeHidden: true },
  ...
  { id: 'settings-pension', label: 'Pension Contributions', description: 'Salary sacrifice, workplace, SIPP and employer pension setup', keywords: ['pension', 'salary sacrifice', 'employee', 'employer', 'sipp', 'contribution', 'nest', 'relief at source', 'net pay', 'auto-enrolment'], tab: 'settings', targetSelector: '[data-search="settings-pension"]' },
