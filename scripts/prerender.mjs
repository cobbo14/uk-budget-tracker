...
const PAGES = [
  ...
  { hash: 'guide/pension-annual-allowance-guide', path: 'guide/pension-annual-allowance-guide', title: 'Pension Annual Allowance Guide UK 2024–27 — Limits & Taper — UK Budget Tracker', description: 'Annual Allowance limits, tapered allowance for high earners, MPAA, carry forward rules, and the Annual Allowance Tax Charge explained.' },
  { hash: 'guide/inheritance-tax-guide', path: 'guide/inheritance-tax-guide', title: 'Inheritance Tax Guide UK — Rates, Nil-Rate Band & Planning — UK Budget Tracker', description: 'IHT rates, nil-rate band, residence nil-rate band, exemptions, the 7-year rule, taper relief, trusts, and planning strategies.' },
  { hash: 'guide/rental-income-tax-guide', path: 'guide/rental-income-tax-guide', title: 'Rental Income Tax Guide UK — Section 24, Expenses & Relief — UK Budget Tracker', description: 'How rental income is taxed, Section 24 mortgage interest restriction, allowable expenses, Rent-a-Room relief, and reporting requirements.' },
  { hash: 'guide/crypto-tax-guide', path: 'guide/crypto-tax-guide', title: 'Crypto Tax Guide UK — HMRC Rules, CGT & Record Keeping — UK Budget Tracker', description: 'How HMRC taxes crypto — CGT on disposals, income tax on staking and mining, pooled cost basis, DeFi, NFTs, and record-keeping.' },
  { hash: 'guide/national-insurance-guide', path: 'guide/national-insurance-guide', title: 'National Insurance Rates & Thresholds UK 2024–27 — UK Budget Tracker', description: 'Employee, employer, and self-employed NI rates, thresholds, voluntary Class 3 contributions, Employment Allowance, and State Pension qualification.' },
]
