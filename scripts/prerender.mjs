...
const PAGES = [
  { hash: 'about', path: 'about', title: 'About — UK Budget Tracker', description: 'Built by an ACA and CTA qualified accountant. Learn how UK Budget Tracker calculates your tax using official HMRC rates for 2025/26 and 2026/27.' },
  ...
  { hash: 'privacy', path: 'privacy', title: 'Privacy Policy — UK Budget Tracker', description: 'How UK Budget Tracker handles your data: everything stays in your browser. No accounts, no server, no tracking of your financial information.' },
  { hash: 'terms', path: 'terms', title: 'Terms of Use — UK Budget Tracker', description: 'Terms of use for UK Budget Tracker — a free tax estimation tool for guidance only, not financial or tax advice.' },
  { hash: 'disclaimer', path: 'disclaimer', title: 'Disclaimer — UK Budget Tracker', description: 'UK Budget Tracker provides estimates based on published HMRC rates. Figures are for guidance only and do not constitute financial or tax advice.' },
  { hash: 'guide', path: 'guide', title: 'UK Tax Guides — Income Tax, Pension, CGT — UK Budget Tracker', description: 'In-depth UK tax guides covering income tax rates, salary sacrifice, the £100k tax trap, and capital gains tax for 2025/26 and 2026/27.' },
  { hash: 'guide/uk-income-tax-rates', path: 'guide/uk-income-tax-rates', title: 'UK Income Tax Rates & Bands 2025/26 & 2026/27 — UK Budget Tracker', description: 'Full rate tables for both tax years, personal allowance, Scottish rates, National Insurance, and worked examples at £30k, £50k, £80k, and £100k.', faqs: [
    { question: 'What is the UK personal allowance for 2025/26 and 2026/27?', answer: 'The personal allowance is £12,570 for both tax years. It is reduced by £1 for every £2 of income above £100,000, meaning it reaches zero at £125,140.' },
  ...
  { hash: 'guide/capital-gains-tax-guide', path: 'guide/capital-gains-tax-guide', title: 'Capital Gains Tax Guide UK 2025–27 — Rates, Reliefs & Examples — UK Budget Tracker', description: 'CGT rates, annual exempt amount, Business Asset Disposal Relief, interaction with income tax, loss relief, and worked examples.', faqs: [
    { question: 'What are the UK Capital Gains Tax rates?', answer: 'Since 30 October 2024, basic-rate taxpayers pay 18% and higher-rate taxpayers pay 24% on all asset types — the same rates now apply to shares and residential property. Business Asset Disposal Relief gives a reduced rate of 14% in 2025/26, rising to 18% from April 2026, up to a £1m lifetime limit.' },
  ...
  { hash: 'guide/student-loan-guide', path: 'guide/student-loan-guide', title: 'Student Loan Repayment Guide UK — Thresholds & Rates — UK Budget Tracker', description: 'Repayment thresholds, rates, and write-off rules for Plan 1, 2, 4, 5, and Postgraduate Loans across the 2025/26 and 2026/27 tax years.', faqs: [
    { question: 'What is the student loan repayment threshold for Plan 2?', answer: 'The Plan 2 repayment threshold is £28,470 for 2025/26 and £29,385 for 2026/27. You repay 9% of income above the threshold.' },
    { question: 'When is my student loan written off?', answer: 'Plan 1 loans are written off 25 years after you were first due to repay. Plan 2 and Postgraduate loans are written off after 30 years. Plan 5 loans are written off 40 years after they first become due for repayment.' },
  ...
  { hash: 'guide/isa-guide', path: 'guide/isa-guide', title: 'ISA Guide UK — Types, Allowances & Rules 2025–27 — UK Budget Tracker', description: 'Cash ISA, Stocks & Shares ISA, Lifetime ISA, and IFISA explained. Allowances, tax benefits, LISA rules, and strategies for 2025–27.', faqs: [
    { question: 'What is the ISA allowance for 2025/26 and 2026/27?', answer: 'The annual ISA allowance is £20,000 per tax year. You can split this across Cash ISA, Stocks & Shares ISA, Lifetime ISA (max £4,000), and Innovative Finance ISA.' },
  ...
  { hash: 'guide/dividend-tax-guide', path: 'guide/dividend-tax-guide', title: 'Dividend Tax Guide UK 2025–27 — Rates & Allowances — UK Budget Tracker', description: 'Dividend tax rates, allowances, how dividends stack on income, strategies for company directors, and worked examples.', faqs: [
    ...
    { question: 'What are the UK dividend tax rates?', answer: 'In 2025/26, basic-rate taxpayers pay 8.75% on dividends above the £500 allowance, higher-rate 33.75%, and additional-rate 39.35%. From April 2026 the basic and higher rates rise to 10.75% and 35.75%. These rates are lower than income tax because companies have already paid Corporation Tax.' },
  ...
  { hash: 'guide/self-employment-tax-guide', path: 'guide/self-employment-tax-guide', title: 'Self-Employment Tax Guide UK — Expenses, NI & Payments on Account — UK Budget Tracker', description: 'How self-employment tax works — trading allowance, allowable expenses, Class 2 & 4 NI, payments on account, and tips to reduce your bill.', faqs: [
    ...
    { question: 'What National Insurance do self-employed people pay?', answer: 'Self-employed pay Class 4 NI (6% on profits between £12,570–£50,270, 2% above £50,270). Compulsory Class 2 was abolished from April 2024 — profits at or above the Small Profits Threshold earn State Pension credits at no cost.' },
  ...
  { hash: 'guide/pension-annual-allowance-guide', path: 'guide/pension-annual-allowance-guide', title: 'Pension Annual Allowance Guide UK 2025–27 — Limits & Taper — UK Budget Tracker', description: 'Annual Allowance limits, tapered allowance for high earners, MPAA, carry forward rules, and the Annual Allowance Tax Charge explained.', faqs: [
    { question: 'What is the pension Annual Allowance?', answer: 'The Annual Allowance is the maximum amount of pension savings you can make each tax year with tax relief. It is £60,000 for 2025/26 and 2026/27. Contributions above this limit trigger an Annual Allowance Tax Charge at your marginal rate.' },
  ...
  { hash: 'guide/national-insurance-guide', path: 'guide/national-insurance-guide', title: 'National Insurance Rates & Thresholds UK 2025–27 — UK Budget Tracker', description: 'Employee, employer, and self-employed NI rates, thresholds, voluntary Class 3 contributions, Employment Allowance, and State Pension qualification.', faqs: [
    { question: 'What are the employee National Insurance rates?', answer: 'Employees pay 8% NI on earnings between £12,570 and £50,270 (Primary Threshold to Upper Earnings Limit), and 2% on earnings above £50,270. These rates apply for 2025/26 and 2026/27.' },
    { question: 'What NI do self-employed people pay?', answer: 'Self-employed pay Class 4 NI (6% on profits between £12,570 and £50,270, 2% above £50,270), collected via Self Assessment. Compulsory Class 2 was abolished from April 2024; it can still be paid voluntarily by those with low profits to protect State Pension entitlement.' },
    { question: 'How many NI qualifying years do I need for the full State Pension?', answer: 'You need 35 qualifying years for the full new State Pension (£11,973/year in 2025/26, rising to £12,548 in 2026/27) and a minimum of 10 qualifying years to receive any State Pension. Gaps can be filled with voluntary Class 3 contributions.' },
  ] },
]
